...
test('8.9.51 final UI runtime is wired after 8.9.50 layers',()=>{
  ...
  assert.match(pkg.version,/^8\.9\.(51|52|53|54|55|56|57|58|59)$/);
  ...
  assert.match(preload,/runtime=895(1|2|3|4|5|6|7|8|9)/);
  assert.match(preload,/dataset\.uchetRuntime='8\.9\.(51|52|53|54|55|56|57|58|59)'/);
});
