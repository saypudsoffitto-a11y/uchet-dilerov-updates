...
test('8.9.61 ships the macOS sync and placeholder-product fix',()=>{
  ...
  assert.match(pkg.version,/^8\.9\.(61|62|63|64|65|66|67|68)$/);
  ...
  assert.match(preload,/runtime=89(61|62|63|64|65|66|67|68)/);
  assert.match(preload,/uchetRuntime='8\.9\.(61|62|63|64|65|66|67|68)'/);
