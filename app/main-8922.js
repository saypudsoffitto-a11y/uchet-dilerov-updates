...
$result=$rec.Recognize([TimeSpan]::FromSeconds(9))
...
`;
    ...
    setTimeout(()=>{try{p.kill()}catch(_){}finish({ok:false,message:'Время ожидания речи истекло. Нажми кнопку и повтори.'})},13000);
  });
});
